...
export function isActive(currentPath, currentHash, matchPath, asRegex = false, skipHashCheck = false) {
 ...
 */
export function resolveSiteDataByRoute(siteData, relativePath, filePath) {
